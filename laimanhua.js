const GB2312_TABLE_B64 = "ADABMAIw+zDJAscCqAADMAUwFSBe/xYgJiAYIBkgHCAdIBQwFTAIMAkwCjALMAwwDTAOMA8wFjAXMBAw" +
  ...
  "AFgeWBlYRFggWGVYbFiBWIlYmliAWKiZGZ//YXmCfYJ/go+KioKogoSCjoKRgpeCmYKrgriCvoKwgsiC" +
...
class LaiManHua extends ComicSource {
    ...
    comic = {
        ...
        // ====== 新增 link 支持 ======
        link: {
            domains: ['www.laimanhua88.com', 'm.laimanhua88.com', 'www.laimanhuaba.com', 'm.laimanhuaba.com'],
            linkToId: (url) => {
                const m = String(url).match(/\/kanmanhua\/([^/?#]+)/);
                return m ? m[1] : null;
            }
        }
    };
